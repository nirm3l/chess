    ...
    public void handle(QuickPairRequestedEvent quickPairRequestedEvent) {
        ...
        while (true) {
            ...
            if (gameId != null) {
                ...
                try {
                    commandGateway.send(new PairPlayerWithGameCommand(gameId, playerId, quickPairRequestedEvent.getRequestId()));
                ...
                commandGateway.send(new CancelPlayerPairingRequestCommand(quickPairRequestedEvent.getRequestId()));
